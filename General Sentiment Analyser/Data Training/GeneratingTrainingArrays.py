...
# Lets generate map which has list of all features
# Primay Feature List
...
twitter_feature_list_file_path = "features_from_twitter"
twitter_feature_list = []
for feature in open(twitter_feature_list_file_path,'r'):
    twitter_feature_list.append(feature.strip())
'''
'''
# Features Extra from Twitter
twitter_feature_list_file_path = "temp"
for feature in open(twitter_feature_list_file_path,'r'):
    twitter_feature_list.append(feature.strip())
'''
...
for feature in primary_feature_list:
    try:
        ...
        i = i+1
'''
for feature in twitter_feature_list:
    try:
        c = base_verb.index(feature)
    except ValueError:
        dict_of_features[feature] = i
...
with open(training, 'r') as csvfile:
    ...
    for tweet in tweets:
        ...
        ##########################################
        #x.append(feature_for_this_tweet)
        if(len(feature_for_this_tweet) == 0):
            continue
...
score2 = correctPredicted

print str(float(score1+score2)/3200.0)
